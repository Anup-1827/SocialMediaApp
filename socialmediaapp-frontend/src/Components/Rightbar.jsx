...
export default function Rightbar({messanger}) {
  return (
    <section className='rightBar'>
       <article className={messanger?'birthDayRemainder hide':"birthDayRemainder"}>
       ...
       <article className={messanger?'party hide':"party"}>
          <h1>cold,</h1>
          <h1>smoothy</h1>
          <h1>& tasty.</h1>
       </article>
